...
const GT5 = ['끝판왕랑사부','우소츠키','아싸다','붉으래','여름빛','Babyee','치느','빛싸다','나유','s하울s','헤세메','보스','제크로무','oO서영Oo','xooos','까치','폭력','승냉','돈가츠','딱꽁','잠원동쓰레빠','다무리','하나둘셋얍','리턴','윤재','치치','조말순','귄성준','v구름v','헤라클','노획','이루릴','KDA','비타민나라','망듕땅','VISVIM','배방3','헤파이토스','해지슬','두비두밥','버기','Doberman','카운터펀치','스팔','EXE','페커리'];
const GT6 = ['끝판왕랑사부','윤재','치치','Babyee','제크로무','스팔','보스','버기','여름빛','리턴','승냉','우소츠키','카운터펀치','다무리','딱꽁','돈가츠','두비두밥','oO서영Oo','Doberman','망듕땅','헤세메','조말순','이루릴','해지슬','빛싸다','나유','노획','페커리','까치','아싸다','잠원동쓰레빠','헤라클','헤파이토스','비타민나라','붉으래','v구름v','치느','KDA','EXE','xooos','배방3','VISVIM','귄성준','폭력','s하울s'];
const SAMPLES = [
